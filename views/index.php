<div class="box box-success">
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: scroll; width: auto; height: 350px;">
        <div id="chat-box" class="box-body <?= $theme == "direct-chat" ? "direct-chat-messages" : "chat" ?>" style="overflow: hidden; width: auto; height: 350px;">
            <?=$data?>
        </div>
    ...
    <div class="box-footer">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button class="btn btn-success btn-send-comment" data-theme="<?= $theme ?>" data-url="<?=$url;?>" data-model="<?=$userModel;?>" data-userfield="<?=$userField;?>" data-loading="<?=$loading;?>"><i class="fa fa-send"></i></button>
            </div>
        </div>
    </div>
</div><!-- /.box (chat box) -->  